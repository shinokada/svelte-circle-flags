...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ><path fill="#d80027" d="M0 0h512v256l-265 45.2z" /><path
      fill="#0052b4"
      d="M210 256h302v256H0z"
    /><path fill="#eee" d="M0 0v512l256-256z" /><g fill="#ffda44"
      ><path d="M28 256a73.1 73.1 0 0 0-.2 5.6 72.3 72.3 0 1 0 144.5-5.6z" /><circle
        cx="100.2"
        cy="200.3"
        r="22.3"
      /></g
    ><path fill="#d80027" d="M50 194.8V267c0 38.4 50.2 50 50.2 50s50-11.6 50-50v-72.3h-100z" /><path
      fill="#338af3"
