<script>
  ...
  export let ariaLabel = 'flag of tibet';
</script>
...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ><path fill="#eee" d="m12.4 481.9 491.1.6-247-247.3z" /><path
      fill="#d80027"
    ...
    /><path fill="#0052b4" d="M295.2 384.1a39 39 0 0 1-78 0" /><path
      fill="#ffda44"
...
@prop export let ariaLabel = 'flag of tibet';
-->
