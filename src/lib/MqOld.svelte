<script>
  ...
  export let ariaLabel = 'flag of mq old';
</script>
...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ...
    /><path fill="#eee" d="M222.6 0v222.6H0v66.8h222.6V512h66.8V289.4H512v-66.8H289.4V0z" /><path
      fill="#eee"
...
@prop export let ariaLabel = 'flag of mq old';
-->
