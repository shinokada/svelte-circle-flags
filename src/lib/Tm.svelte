...
<svg
	...
	><path fill="#496e2d" d="M0 0h66.8l67.8 32.3L200.3 0H512v512H200.3l-70.2-34.1L66.8 512H0z" /><path
		fill="#d80027"
		d="M66.8 0h133.5v512H66.8z"
	/><g fill="#eee"
		><path
	...
	/><g fill="#d80027"
		><path d="M122.4 244.9h22.3V267h-22.3z" /><circle cx="133.6" cy="181.2" r="11.1" /><circle
			...
			r="11.1"
		/></g
	><path fill="#eee" d="m117.8 434-22.4-16.8v-12l38.2-28 15.8-.1 22.3 16.7v11.5L133.6 434z" /><path
		fill="#ff9811"
