<script>
  ...
  export let ariaLabel = 'flag of kikuyu';
</script>
...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ><path fill="#eee" d="m228 0 32 211-32 211h-32l-32-211L196 0Z" /><path
      fill="#496e2d"
      d="M196 0v450H0V0Z"
    /><path
      fill="#eee"
      d="m178 87-31-14-49 112L49 73 18 87l62 138-62 138 31 14 49-112 49 112 31-14-62-138Z"
    /><path fill="#eee" d="M98 80 81 96 65 224l16 130 17 16 17-16 15-131-15-127-17-16Z" /><path
      fill="#333"
    ...
    /><path fill="#d80027" d="M512 0v422H228V0Z" /><path
      fill="#333"
...
@prop export let ariaLabel = 'flag of kikuyu';
-->
