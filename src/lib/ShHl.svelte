<script>
  ...
  export let ariaLabel = 'flag of sh hl';
</script>
...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ...
    /><path fill="#eee" d="M288 128h160v80l-80 32-80-32z" /><path
      fill="#333"
    ...
    /><path fill="#338af3" d="M288 208v48c0 61 80 80 80 80s80-19 80-80v-48z" /><path
      fill="#eee"
...
@prop export let ariaLabel = 'flag of sh hl';
-->
