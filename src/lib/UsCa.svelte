<script>
  ...
  export let ariaLabel = 'flag of us ca';
</script>
...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ><path fill="#eee" d="M0 0h512v416l-256 32L0 416Z" /><path
      fill="#6da544"
    ...
    /><path fill="#d80027" d="M0 416h512v96H0Z" /><path
      fill="#584528"
      d="M288 340h140v32H288z"
...
@prop export let ariaLabel = 'flag of us ca';
-->
