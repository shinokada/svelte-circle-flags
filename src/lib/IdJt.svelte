<script>
  ...
  export let ariaLabel = 'flag of id jt';
</script>
...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ><path fill="#ffda44" d="M0 0h512v512H0Z" /><path
      fill="#d80027"
      d="m256 114-6 2-95 78c-4 3-4 9-1 13l102-33 102 33c3-4 3-10-1-13l-95-78-6-2z"
    /><path fill="#eee" d="M278 231h-1zm-43 0z" /><path
      fill="#6da544"
    ...
    /><path fill="#338af3" d="m183 290 11 32h124l11-32h-73z" /><path
      fill="#eee"
    ...
    /><rect width="9" height="142" x="252" y="170" fill="#ff9811" rx="4.5" ry="4.5" /><rect
      width="128"
      height="24"
      x="192"
      y="338"
      ...
      rx="12"
      ry="12"
    /><rect width="160" height="24" x="176" y="350" fill="#eee" rx="12" ry="12" /><path
      fill="#ffda44"
      d="m242 191 14-42 14 42-36-26h44z"
    /></g
  ></svg
>
...
@prop export let ariaLabel = 'flag of id jt';
-->
