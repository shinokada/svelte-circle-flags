<script>
  ...
  export let ariaLabel = 'flag of in tn';
</script>
...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ...
    /><path fill="#ffda44" d="M199 86v51l-25 153-38 31h240l-38-31-25-153V86H199z" /><path
      fill="#ff9811"
      d="M136 321h240v24H136z"
    /><path fill="#eee" d="M136 345h240v24H136z" /><path
      fill="#6da544"
      d="M136 369h240v24H136z"
    /><circle cx="191" cy="357" r="8" fill="#0052b4" /><circle
      cx="-321"
      cy="357"
      r="8"
      fill="#0052b4"
...
@prop export let ariaLabel = 'flag of in tn';
-->
