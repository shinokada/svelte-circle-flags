<script>
  ...
  export let ariaLabel = 'flag of au act';
</script>
...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ><path fill="#0052b4" d="M0 0h170l64 256-64 256H0Z" /><path
      fill="#ffda44"
      d="M170 0h342v512H170z"
    /><path
      fill="#eee"
    ...
    /><g transform="translate(0 22)"
      ...
      /><path fill="#0052b4" d="M285.5 200v68c0 34 44.5 44 44.5 44s44.5-10 44.5-44v-68z" /><path
        fill="#eee"
      ...
      /><circle cx="330" cy="297.2" r="9" fill="#eee" /></g
    ></g
  ></svg
>
...
@prop export let ariaLabel = 'flag of au act';
-->
