<script>
  ...
  export let ariaLabel = 'flag of yorubaland';
</script>
...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ><path fill="#eee" d="M384 0h128v128L352 352 128 512H0V384l160-224Z" /><path
      fill="#338af3"
      d="M0 384 384 0H0Z"
    /><path fill="#6da544" d="M512 128 128 512h384z" /><path
      fill="#ffda44"
...
@prop export let ariaLabel = 'flag of yorubaland';
-->
