<script>
  ...
  export let ariaLabel = 'flag of id jb';
</script>
...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ...
    /><path fill="#0052b4" d="m179 300 12 44 65 32 65-32 12-44H179z" /><path
      fill="#333"
    ...
    /><rect width="8" height="27" x="252" y="260" fill="#d80027" rx="4" ry="4" /></g
  ></svg
>
...
@prop export let ariaLabel = 'flag of id jb';
-->
