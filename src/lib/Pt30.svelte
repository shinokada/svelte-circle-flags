<script>
  ...
  export let ariaLabel = 'flag of pt 30';
</script>
...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ...
    /><path fill="#eee" d="M323 244.9h-56v-55.7h-22V245h-55.7v22H245v55.7h22V267h55.7z" /></g
  ></svg
>
...
@prop export let ariaLabel = 'flag of pt 30';
-->
