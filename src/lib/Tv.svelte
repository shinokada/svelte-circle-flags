...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ><path fill="#338af3" d="M0 256 256 0h256v512H0z" /><path
      fill="#eee"
    ...
    /><path fill="#d80027" d="m256 224.5-91-91h-31.4L256 256z" /><path
      fill="#d80027"
    ...
    /><path fill="#0052b4" d="M180.8 133.6H256v75.2zm-47.2 47.2v75.3l75.2-.1z" /></g
  ></svg
>
