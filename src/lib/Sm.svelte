...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ><path fill="#338af3" d="m0 256 256-52.3L512 256v256H0z" /><path
      fill="#eee"
      d="M0 0h512v256H0z"
    /><path
      fill="#6da544"
    ...
    /><path fill="#338af3" d="M311.7 278.3v-33.4a55.7 55.7 0 0 0-111.4 0v33.4l55.7 11z" /><path
      fill="#6da544"
      d="M200.3 278.3a55.7 55.7 0 0 0 111.4 0z"
    /><path
      fill="#ffda44"
