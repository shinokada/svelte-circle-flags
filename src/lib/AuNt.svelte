<script>
  ...
  export let ariaLabel = 'flag of au nt';
</script>
...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ><path fill="#333" d="M0 0h171l64 256-64 256H0Z" /><path
      fill="#ff9811"
      d="M171 0h341v512H171z"
    /><path
      fill="#333"
    ...
    /><path fill="#eee" d="M358 237c14 18 75 0 45-37-29-37-60 18-45 37z" /><path
      fill="#eee"
      d="M330 224c23 0 47-59 0-59s-23 59 0 59z"
    /><path
      fill="#eee"
...
@prop export let ariaLabel = 'flag of au nt';
-->
