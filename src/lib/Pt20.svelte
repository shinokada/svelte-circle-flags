<script>
  ...
  export let ariaLabel = 'flag of pt 20';
</script>
...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ><path fill="#0052b4" d="M0 512h189.2l41.4-256L189.2 0H0z" /><path
      fill="#eee"
      d="M189.2 0H512v512H189.2z"
    /><path fill="#d80027" d="M91.8 89v41.8a37.6 37.6 0 1 0 75.2 0V89z" /><path
      fill="#eee"
...
@prop export let ariaLabel = 'flag of pt 20';
-->
