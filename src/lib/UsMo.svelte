<script>
  ...
  export let ariaLabel = 'flag of us mo';
</script>
...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ><path fill="#eee" d="m0 170 256-64 256 64v172l-256 64L0 342Z" /><path
      fill="#d80027"
      d="M0 0h512v170H0Z"
    /><path fill="#0052b4" d="M0 342h512v170H0Z" /><circle
      cx="256"
      cy="256"
      r="160"
      fill="#0052b4"
    /><circle cx="256" cy="256" r="104" fill="#eee" /><path
      fill="#eee"
    ...
    /><path fill="#338af3" d="M256 168a88 88 0 0 0-74.9 42H331a88 88 0 0 0-75-42z" /><circle
      cx="256"
      cy="280"
      r="56"
      fill="#ff9811"
    /><path fill="#eee" d="M288 280a32 32 0 0 1-32 32l-16-32 16-32a32 32 0 0 1 32 32z" /><path
      fill="#0052b4"
      d="M256 248a32 32 0 0 0-32 32l16 16 16-16z"
    /><path fill="#d80027" d="M256 312a32 32 0 0 1-32-32h32z" /></g
  ></svg
>
...
@prop export let ariaLabel = 'flag of us mo';
-->
