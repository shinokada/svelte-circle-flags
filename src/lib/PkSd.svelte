<script>
  ...
  export let ariaLabel = 'flag of pk sd';
</script>
...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ><path fill="#496e2d" d="M0 0h512v512H0z" /><ellipse
      cx="256"
      cy="284"
      fill="#eee"
      rx="140"
      ry="132"
    /><ellipse cx="256" cy="249" fill="#496e2d" rx="122" ry="111" /><path
      fill="#eee"
...
@prop export let ariaLabel = 'flag of pk sd';
-->
