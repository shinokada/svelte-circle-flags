...
<svg
  ...
  ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
    ><path fill="#eee" d="M144 0h223l33 256-33 256H144l-32-256z" /><path
      fill="#496e2d"
      d="M0 0h144v512H0z"
    /><path fill="#d80027" d="M368 0h144v512H368z" /><path
      fill="#ffda44"
      d="M256 277v10h12l10-22z"
    /><path
      fill="#496e2d"
    ...
    /><path fill="#ffda44" d="m234 186-12 11v11l18-9c3-1 3-5 1-7z" /><circle
      cx="172"
      cy="275"
      r="8"
      fill="#ffda44"
    ...
    /><circle cx="297" cy="323" r="8" fill="#ffda44" /><circle
      ...
      r="8"
      fill="#ffda44"
    /><circle cx="341" cy="275" r="8" fill="#ffda44" /><rect
      width="34"
      height="22"
      x="239"
      y="299"
