...
<MetaTags
  ...
  openGraph={{
    ...
    images: [
      {
        url: 'https://open-graph-vercel.vercel.app/api/svelte-circle-flags',
        width: 1200,
        height: 630,
        alt: 'Svelte Circle Flags Icons'
      }
    ],
    siteName: 'Svelte Circle Flags'
  }}
  twitter={{
    handle: '@shinokada',
    ...
    title: 'Svelte Circle Flags',
    description: 'Circle Flags icon set for Svelte',
    image: 'https://open-graph-vercel.vercel.app/api/svelte-circle-flags',
...
<div class="max-h-screen overflow-auto relative w-full" id="svelte">
  <header
    class="sticky top-0 z-40 flex-none w-full mx-auto bg-white border-b border-gray-200 dark:border-gray-600 dark:bg-zinc-700"
  >
    <Navbar color="default" fluid let:hidden let:toggle class="dark:bg-zinc-700 ">
      <NavBrand href="/">
        <span
  ...
  <Footer footerType="logo" class="dark:bg-zinc-700">
    <div class="sm:flex sm:items-center sm:justify-between">
      ...
      >
        ...
        <FooterLink href="https://github.com/shinokada/svelte-circle-flags/blob/main/LICENSE"
          >Licensing</FooterLink
        >
        <FooterLink href="https://github.com/shinokada/svelte-circle-flags/">GitHub</FooterLink>
      </FooterLinkGroup>
    </div>
  </Footer>
</div>
